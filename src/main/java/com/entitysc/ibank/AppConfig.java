...
@ComponentScan(basePackages = {"com.entitysc.ibank"})
@EnableJpaRepositories(basePackages = {"com.entitysc.ibank .repository"})
...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.entitysc.ibank .model"});
