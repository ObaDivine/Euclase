...
@ComponentScan(basePackages = {"com.entitysc.euclase"})
@EnableJpaRepositories(basePackages = {"com.entitysc.euclase.repository"})
...
public class AppConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.entitysc.euclase.model"});
