...
@ComponentScan(basePackages = {"com.entitysc.euclasefe"})
@EnableJpaRepositories(basePackages = {"com.entitysc.euclase.fe.repository"})
...
public class AppConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.entitysc.euclase.fe.model"});
