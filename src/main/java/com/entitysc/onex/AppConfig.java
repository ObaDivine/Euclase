...
@ComponentScan(basePackages = {"com.entitysc.onex"})
@EnableJpaRepositories(basePackages = {"com.entitysc.onex.repository"})
...
public class AppConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.entitysc.onex.model"});
